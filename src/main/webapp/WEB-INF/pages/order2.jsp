...
<html lang="zh-CN">
    <head>
        ...
        <link rel="stylesheet" href="/resources/css/bootstrap/font-awesome.css">
					...
					<input type="hidden" name="amount">
					  <div class="weui_cells_title">创建订单</div>
					    <div class="weui_cells weui_cells_form">
					        ...
					        <div class="weui_cell">
					            <div class="weui_cell_hd">
					                <label class="weui_label"><i class="icon-time"></i>搬家时间</label>
					            </div>
					            <div class="weui_cell_bd weui_cell_primary">
					        ...
					        <div class="weui_cell">
					            <div class="weui_cell_hd">
					                <label class="weui_label"><i class="icon-user"></i>联系人</label>
					            </div>
					            <div class="weui_cell_bd weui_cell_primary">
